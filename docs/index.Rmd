...
For this analysis, GLP focused on the peer cities of Charlotte, Nashville and Indianapolis. These are all cities in which the city and county governments are combined (like Louisville). This allows for a more accurate comparison of public safety spending.

**Add explanation of the percentage of budget spent on personnel, etc**
