...
The Crisis Intervention Team (CIT) model is a popular training program that teaches officers how to interact with and respond to those experiencing a mental health crisis. 
...
Additionally, in February 2021, LMPD created its Mobile Response Unit with two homelessness officers. The unit has performed wellness checks and partnered with various community organizations to document homelessness and provide various resources. 
